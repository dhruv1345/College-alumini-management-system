...
mycursor.execute("CREATE TABLE IF NOT EXISTS ALUREG (ALU_ID VARCHAR(20) PRIMARY KEY,FIRST_NAME VARCHAR(20),LAST_NAME VARCHAR(20),DOB DATE,GENDER VARCHAR(10),ADD_CORR VARCHAR(20),ADD_OFFC VARCHAR(20),EMAIL_ADD VARCHAR(30),MOB_NO VARCHAR(10),CURR_CITY VARCHAR(20),URR_COMPANY VARCHAR(20),DESG VARCHAR(20),SESSION_FROM VARCHAR(4),SESSION_TO VARCHAR(4),BRANCH VARCHAR(20),APSWD VARCHAR(30))")
mycursor.execute("CREATE TABLE IF NOT EXISTS EVENTS(EID VARCHAR(20) PRIMARY KEY,ENAME VARCHAR(30),EDATE DATE,EVENUE VARCHAR(20),STATUS VARCHAR(30))")
mycursor.execute("CREATE TABLE IF NOT EXISTS SELECTED_EVENTS(ALU_ID VARCHAR(20),ALU_NAME VARCHAR(30),EID VARCHAR(20),ENAME VARCHAR(30),EDATE DATE,EVENUE VARCHAR(30),STATUS VARCHAR(30) DEFAULT 'WILL NOT ATTEND')")
mycursor.execute("CREATE TABLE IF NOT EXISTS ADMIN(A_ID CHAR(10) PRIMARY KEY, A_NAME VARCHAR(20),A_GENDER CHAR(1), A_AGE INT(3),A_PHONE CHAR(10),A_PSWD VARCHAR(20))")
        ...
        if len(res)==0:
            ...
            if len(res)==0:
                ...
                for i in res:
                    ...
                    evenue=i[3]
                    status="CONFIRMED"
                mycursor.execute("insert into selected_events values(%s,%s,%s,%s,%s,%s,%s)",(aid,aname,eid,ename,edate,evenue,status,))
                constr.commit()
                print("\t===================================")
